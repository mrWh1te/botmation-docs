...
const Top_Right_Corner = styled.div`
  ...
  right: 0;
`;
const Bottom_Rightish = styled.div`
  position: fixed;
  right: 5px;
  bottom: 0;
`;
...
export const Wrapper = (props) => {
  return (
    <Wrapper_Inner isMenuOpen={props.isMenuOpen}>
      ...
      <Bottom_Rightish>
        <a href="https://www.npmjs.com/package/botmation" target="_blank" aria-label="View module on NPM" >
          <NPM_Logo />
        </a>
      </Bottom_Rightish>
    </Wrapper_Inner>
