...
With [Botmation](https://github.com/mrWh1te/Botmation), you get a simple, composable, scalable, declarative pattern to build Puppeteer web bots. It reduces code reusing barriers and maximizes web bots' code *readability*, *maintainability* and *testability*.
