...
With [Botmation](https://github.com/mrWh1te/Botmation), you spend less time writing and maintaining Puppeteer code and more time solving high level problems. Botmation provides a simple declarative pattern that scales Puppeteer code while keeping it readable, testable, and *composable* (reusable with less barriers).

Botmation has a simple pattern, a learn at your own pace collection of functions, to ease your efforts in beginning with Functional programming.
