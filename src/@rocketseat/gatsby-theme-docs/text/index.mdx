...
With [Botmation](https://github.com/mrWh1te/Botmation), you can write less Puppeteer code and do more. By following its simple pattern, your code will be easily readable, testable, and *composable* (reusable without limits).
