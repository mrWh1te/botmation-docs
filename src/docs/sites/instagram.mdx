...
These functions focus on Instagram's web app. Here is a working [example](https://github.com/mrWh1te/Botmation/blob/master/apps/bot-instagram).
...
All BotActions, helpers, and selectors listed on this page, are exported by that package.
