...
This BotAction attempts to delete an IndexedDB database, provided the database name. It's possible for this to fail, you can read more about the underlying logic [here](https://developer.mozilla.org/en-US/docs/Web/API/IDBFactory/deleteDatabase).
...
This BotAction is compatible with the [indexedDBStore()()](#indexeddbstore) injector for providing the name of the database for deletion.
