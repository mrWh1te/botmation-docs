...
A highly composable BotAction for setting the first set of [injects](/topic/injects) in a new line of BotAction's while appending the higher order `injects` at the end.
...
Here is an usage [example](/topic/injects#inject-botaction).