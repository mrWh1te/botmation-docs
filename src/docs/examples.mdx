...
The [Instagram example](https://github.com/mrWh1te/Botmation/tree/master/src/examples/instagram.ts) is built with BotAction's made for Instagram's web app.
...
[isGuest](/sites/instagram#isguest-conditionalbotaction) and [isLoggedIn](/sites/instagram#isloggedin-conditionalbotaction) are a special kind of BotAction called ConditionalBotAction.
