...
In Botmation, any one of those people in line 🧍, can actually be a whole other line of people 🧍🧍🧍. Then any one of those people in this embedded line, can also be a whole other line of people 🧍🧍🧍🧍🧍, and infinitely deep ♾️. It doesn't matter, because a BotAction can be a small specific async operation or a line of other BotAction's.
