...
Imagine a line of people at a coffee shop ☕. As 🧍 🧍 🧍 customers enter, a 🧍🧍🧍 line forms with the last person who entered the shop at the end of the line. The first person served is the first person in. 

> First come -> First served

BotAction lines work like that. BotAction's are ran in the order declared, from first to last.

But wait, there's more. Any 🧍 person in 🧍🧍🧍 line, can actually be a separate 🧍🧍🧍 line of people. Then any one of those people in this sub-line, can be another 🧍🧍🧍 line of people, and ♾️ infinitely deep 🐇. It's all composable. A BotAction can be a specific async operation or an assembled line of other BotAction's.
