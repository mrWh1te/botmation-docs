...
But wait, there's more. Any 🧍 person in 🧍🧍🧍 line, can actually be a whole other 🧍🧍🧍 line of people. And any one of those people in this "child" line, can be a whole other 🧍🧍🧍 line of people, and so and so forth ♾️🐇. It's all composable, partly because all these async functions follow the BotAction interface. A BotAction can be a specific async operation or it can be a whole other line of BotAction's.
